...
// const FilterItem = ({ label, icon, count, onToggle }) => {
...
//     return (
//         <label className={`group flex items-center justify-between p-2.5 rounded-lg cursor-pointer transition-all duration-200
//             ${isActive ? 'bg-red-50 text-red-600' : 'hover:bg-slate-50 text-slate-600'}`}>
...
//             isAdded ? [...prev, label] : prev.filter((item) => item !== label)
//         );
//     };

//     useEffect(() => {
//         dispatch(setBusTypes(selectedBusTypes));
//     }, [selectedBusTypes, dispatch, bustypes]);
...
//                 <FilterItem label="Seater" icon="ri-hand-coin-line" onToggle={(c) => handleBusToggle("seater", c)} />
//                 <FilterItem label="Sleeper" icon="ri-hotel-bed-line" onToggle={(c) => handleBusToggle("sleeper", c)} />
//                 <FilterItem label="AC" icon="ri-windy-line" onToggle={(c) => handleBusToggle("Ac", c)} />
//                 <FilterItem label="Non-AC" icon="ri-temp-hot-line" onToggle={(c) => handleBusToggle("Non-Ac", c)} />
//             </FilterSection>
//         </aside>
//     );
// };
